...
const pipes = [ValidTileIdPipe, TranslatePipe, SubMatrixPipe, GetBgClassPipe, CharacterToTilePipe, FilterCharactersPipe, GetStatusPathPipe, GetCharIconClassPipe];
